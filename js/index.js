...
(function () {
    // 实例化对象
    const myCharts = echarts.init(document.querySelector('.pie-left .chart'))

    const option = {
        // ['#1089e7', '#f57474', '#56d0e3', '#f8b448', '#8b78f6']
        color: ['#1089e7', '#066eab', '#0682ab', '#0696ab', '#56d0e3'],
        tooltip: {
            trigger: 'item',
...
(function () {
    // 实例化对象
    const myCharts = echarts.init(document.querySelector('.pie-right .chart'))
...
(function () {
    // 实例化对象
    const myCharts = echarts.init(document.querySelector('.map-box .map-chart'))
    ...
    const NNData = [
        [{ name: '南宁' }, { name: '北京', value: 100 }],
        [{ name: '南宁' }, { name: '广州', value: 100 }],
        [{ name: '南宁' }, { name: '上海', value: 100 }],
        [{ name: '南宁' }, { name: '西安', value: 100 }],
        [{ name: '南宁' }, { name: '西宁', value: 100 }],
    ]
    ...
    const color = ['#a6c84c', '#ffa022', '#46bee9', '#1d9dff', '#a6c84c', '#46bee9'];//航线的颜色
    let series = [];
    [
        ['西安', XAData],
        ['西宁', XNData],
